...
import { Form, Input, InputNumber, Cascader, Select, Row, Col, Checkbox, Button, AutoComplete, Radio, DatePicker, notification, TimePicker, Divider, Skeleton } from "antd";
...
const NeedleStick = () => {
  ...
  return isInitialLoading ? (
    <Skeleton active paragraph={{ rows: 20 }}  style={{ maxWidth: "600px", margin: "auto" }} />
  ) : (
    <Form initialValues={initialValues} labelCol={{ span: 9 }} wrapperCol={{ span: 8 }} form={form} name="needle-stick" onFinish={onFinish} scrollToFirstError>
